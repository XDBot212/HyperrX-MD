...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'This command can only be used by _*Real Owner Bot*_',
        ...
        group: 'This command can only be used in _*Group*_!',
        private: 'This command can only be used in _*Private Chat*_!',
        admin: 'This command is only for _*Admin*_ group!',
        botAdmin: 'Make bot as *Admin* to use this command!',
        unreg: 'Please register to use this feature by typing:\n\n*#daftar name.age*\n\nExample: *#daftar HyperrX.13*',
